package net.shadow.aquifer.items.weapons.infestructure;
...
public class TrueRangedWeapon extends Item {
    ...
    public TrueRangedWeapon(Item.Settings settings) {
        super(settings);
    }
        ...
        for (int j = 0; j < projectiles.size(); j++) {
            ...
            if (!itemStack.isEmpty()) {
                ...
                ProjectileEntity.spawn(
                        this.createEntity(world, shooter, stack, itemStack, critical),
                        world,
                        itemStack,
    ...
    protected ProjectileEntity createEntity(World world, LivingEntity shooter, ItemStack weaponStack, ItemStack projectileStack, boolean critical) {
